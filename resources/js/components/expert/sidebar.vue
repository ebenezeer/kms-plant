      ...
      <nav class="col-md-2 d-none d-md-block bg-light sidebar">
        <div class="sidebar-sticky">
          <ul class="nav flex-column">
            <li class="nav-item">
              <router-link class="nav-link" to="/expert/home"
            ...
            <li class="nav-item">
              <router-link class="nav-link" to="/expert/graft-details"
                >Graft Techniques</router-link
              >
            </li>
            <li class="nav-item">
              <router-link class="nav-link" to="/expert/plant-name"
                >Plant Name</router-link
              >
            </li>
            <li class="nav-item">
              <router-link class="nav-link" to="/expert/variety"
                >Variety</router-link
              >
            </li>
            <li class="nav-item">
              <a class="nav-link" href="/expert/logout">Logout</a>
            </li>
          </ul>
        </div>
      </nav>
