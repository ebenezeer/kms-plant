        ...
        <div class="card">
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-md-4">
                <h1>
                  <router-link to="/admin/plant-detail">
                    <img
              ...
              <div class="col-md-4">
                <h1>
                  <router-link to="/admin/graft-details">
                    <img
...
export default {
  ...
  methods: {
    getuser() {
      axios.get("/admin/get-user-details").then(({ data }) => {
        this.user_name = data;
      });
    },
    getcomments() {
